...
namespace bug_tracker_web.Controllers
{
    public class AdminController : Controller
    {
        ...
        public IActionResult ListAllRoles()
        {
            ...
            var users = _userManager.Users.ToList(); // Retrieve the users

            var viewModel = new ListAllRolesViewModel
            {
                Roles = roles,
                Users = users,
                UserManager = _userManager // Add the _userManager variable to the view model
            };
