...
namespace bug_tracker_web.Migrations
{
    ...
    [Migration("20230525044711_AddBugSeverityAndStatusColumns2")]
    partial class AddBugSeverityAndStatusColumns2
    {
            ...
            modelBuilder.Entity("bug_tracker_web.Models.Bug", b =>
                {
                    ...
                    b.Property<int>("BugSeverityValue")
                        .HasColumnType("int");

                    b.Property<int>("BugStatusValue")
                        .HasColumnType("int");
